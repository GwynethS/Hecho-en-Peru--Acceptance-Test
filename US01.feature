...
Scenario: usuario visualiza el formulario de registro de la pagina web
    ...
    Then el sistema muestra en una nueva pagina el formulario "Registrarse" con los campos <Nombre>, <Apellido>, <Correo electronico> y <Contrasena> los cuales son requeridos
